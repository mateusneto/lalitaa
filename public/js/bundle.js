    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/usuarios/updatePassword' : '/api/v1/usuarios/updateMe'; // console.log(data);
...
var logOutBtn = document.querySelector('.side-nav__logoutbtn');
...
var bookBtn = document.getElementById('comprar-servico'); //Delegation
